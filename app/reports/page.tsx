      ...
      <section className="pt-24 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {[
              { icon: Users, label: "Total Patients", value: (analytics?.total_patients ?? 0).toString(), change: "+12%", positive: true },
              { icon: DollarSign, label: "Total Revenue", value: `$${((analytics?.total_revenue ?? 0) / 1000).toFixed(1)}K`, change: "+15%", positive: true },
              { icon: Bed, label: "Bed Occupancy", value: `${analytics?.occupancy_rate ?? 78}%`, change: "-3%", positive: false },
